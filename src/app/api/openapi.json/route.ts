  ...
  return NextResponse.json(
    {
      ...
      components: {
        securitySchemes: {
          bearerAuth: { type: 'http', scheme: 'bearer', description: `A ${SITE.name} API key, "mw_live_...".` },
        },
        schemas: {
          AnalysisResult: {
            type: 'object',
