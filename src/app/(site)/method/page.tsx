...
export const metadata: Metadata = {
  title: 'Method',
  description: `Exactly what ${SITE.name} measures: a keyed green-list watermark z test, a key-free register measurement against per-language corpus baselines, and a false-discovery-rate correction on per-passage findings.`,
  ...
  return (
    <>
      ...
      <PageHeader
        ...
        lead={`Everything ${SITE.name} reports is one of two measurements. This page is the whole method, including the parts that limit what it can tell you.`}
      />
      ...
      <article className="mx-auto max-w-3xl px-5 pt-14">
        ...
        <section className="mt-10 rounded-[var(--radius-panel)] border border-seal-300 bg-seal-50 p-5">
          ...
          <p className="mt-3 text-[15px] leading-relaxed text-seal-700">
            {SITE.name} therefore tests the keys it holds and names them on every result. It ships a
