...
/**
 * WatermarkRemoverPro's long-tail content: /for/*, /vs/*, /guide/* and /in/*.
 *
 ...
 *
 * This brand's register throughout: statistical, evidentiary, post-accusation.
 * The audience is someone who has been accused, or fears being accused, of
 * using AI, and needs a defensible, dated test to point to. See
 * docs/neverprompted_launch_strategy.md for why NeverPrompted's own content
 * (../neverprompted/pages.ts) deliberately does not share this register.
 */
