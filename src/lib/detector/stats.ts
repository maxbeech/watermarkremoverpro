 ...
 * calculation. If a figure appears on a result screen or evidence report, on
 * either brand, it came through one of these functions from the document's own counts.
 */
