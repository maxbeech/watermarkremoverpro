...
export function Calibrator() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Error Display */}
      {error && (
        <div className="rounded-[var(--radius-panel)] border border-signal-200 bg-signal-50 p-4">
      ...
      {result && result.status === 'ok' && (
        <div className="space-y-6">
          ...
          {/* No Changes Info */}
          {result.substitutions.length === 0 && (
            <div className="rounded-[var(--radius-panel)] border border-ink-200 bg-ink-50 p-4">
      ...
      {!result && !error && !isLoading && text.trim().length > 0 && (
        <div className="rounded-[var(--radius-panel)] border border-ink-200 bg-ink-50 p-8 text-center">
