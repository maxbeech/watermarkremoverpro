...
The original text is kept for history at
[`docs/archive/NO_REMOVAL.md`](archive/NO_REMOVAL.md), since it is referenced
elsewhere and useful context for why the original policy was a deliberate
