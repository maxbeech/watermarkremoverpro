...
construction, and there is no donor string in this repo to find.
...
1. **Watermark (keyed).** Green-list z test after Kirchenbauer et al. 2023
   (arXiv:2301.10226). Distinct word bigrams are scored once each, because counting a
...
before being kept, because the API was asked for Spanish and is generally telling the
